...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-brand-gold/5 rounded-full -ml-64 -mt-64 blur-3xl"></div>
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-brand-gold/5 rounded-full -mr-64 -mb-64 blur-3xl"></div>
      ...
      <div className="w-full max-w-[460px] z-10 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-text-muted mt-2">Join the LUMIÈRE management team</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-[32px] shadow-2xl">
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-white/50 uppercase tracking-widest ml-1">Security Password</label>
              <div className="relative group">
            ...
            <div className="flex items-start gap-3 p-4 bg-white/5 border border-white/5 rounded-2xl">
              ...
              <p className="text-[11px] text-text-muted leading-relaxed">
                By creating an account, you agree to our <span className="text-white font-bold">Admin Terms of Service</span> and <span className="text-white font-bold">Data Access Policy</span>.
              </p>
            </div>
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full bg-brand-gold hover:brightness-110 disabled:brightness-75 text-white font-bold py-4 rounded-2xl shadow-xl shadow-brand-gold/20 transition-all flex items-center justify-center gap-2 group mt-6"
            >
              {isLoading ? (
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-sm text-text-muted">
              ...
              <Link href="/signin" className="text-brand-gold font-bold hover:underline transition-all">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
